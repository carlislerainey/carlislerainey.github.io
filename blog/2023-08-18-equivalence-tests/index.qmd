...
1. For a more recent example, Jake Jares and Neil Malhotra have a [new paper](https://jakejares.com/uploads/Jares%20and%20Malhotra%20%282023%29%20--%20Policy%20Impact%20and%20Voter%20Mobilization.pdf) that discusses negligible effects and hypothesis tests in a way that I find clear and compelling. It's an excellent model. See pp. 26-31. They "show that improved compensation outcomes had negligible impacts on Republican farmers' midterm turnout and campaign contributions, even though such variation in benefits significantly affected whether farmers viewed the intervention as helpful."
