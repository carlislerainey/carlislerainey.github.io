...
In @rainey2021, Kelly McCaskey and I offer an accessible and practical (re)introduction to Firth's penalized maximum likelihood estimator that (1) corrects the small sample bias and (2) reduces the excessive variance of the usual maximum likelihood estimator.
...
From my perspective, these are the two main papers to refer to if you're concerned about small sample bias in logistic regression models.
