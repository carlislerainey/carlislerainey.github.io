...
By "everyday," I mean at least every weekday, probably at the same time every day and probably first thing in the morning. For better or worse, academics are evaluated on their research productivity.
...
#| fig-alt: "Horizontal bar chart of hours per week early-career academics spend on seven activities, colored by category (Teaching, Administration, Writing). Lecture Preparation and Grading (12.5 hrs) and Classroom Teaching (9 hrs) dominate; Committee Meetings (2 hrs) exceeds Scholarly Writing (0.5 hrs), with Research and Scholarly Reading at 1 hr. Data from Boice (1989)."
...
- The **spontaneous** group agreed to write when they felt like it.
- The **contingency** group agreed to donate to an anti-charity if they failed to write every day.

The figure below shows that a regular writing routine increases production of both pages *and* ideas. Notice that the spontaneous writers barely produced more ideas and pages than the group trying to *avoid* writing.


```{r echo=FALSE, fig.height=3, fig.width=6, message=FALSE, warning=FALSE}
#| fig-alt: "Two line-and-point panels, one for Pages Per Day and one for Ideas Per Day, each showing pre- and post-intervention values for three groups (Control, Spontaneous, Contingency) in Boice's writing experiment. Both measures rise from pre- to post-intervention for all three groups, with the Contingency group's post-intervention pages (3.2/day) and ideas rising the most and the Control group's rising the least."
...
1. Avoid writing outside this window. Set your window so that it's "enough."
...
1. Family permitting, I think it's helpful to spend a little while pushing the projects forward on the weekends, just to keep the momentum up.^[Just 15 minutes is great. This slot is perfect for proofreading.]
...
It's my view that PhD students should write every day, from the first day of their first semester (remember that I have a broad definition of "write"). Most students need some time before they're ready to jump into the technical details of a solo project, but there are always things to do.
