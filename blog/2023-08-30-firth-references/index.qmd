...
@firth1993 originally introduced the idea. Kelly and I draw mostly on this paper---it's a wonderful paper. While our paper was working it's way through the review process, @kosmidis2021 follow-up with additional theoretical results that are relevant for the estimator as used in practice since 1993. Most importantly, they discuss the shrinkage property of the estimator, which is what Kelly and I highlight as under-appreciated. From my perpective, these are the two main papers to refer to if you're concerned about small sample bias in logistic regression models.
