...
subtitle: "Type II Errors Are Not Errors, They're Wasted Opportunities"
...
This perspective helps motivate power calculations. By their design, tests control the error rate in certain situations (when the null is correct). You do not need to worry about Type I errors. First, the test controls the error rate under the null. Second, you are pretty sure the null is wrong (see your theory section).

::: {.callout-important}
## Important Point
The hypothesis test takes care of the Type I error rate. If you choose a properly-sized test, you don't need to worry about those errors any more.
:::

If you aren't worried about Type I errors, what are you worried about? The only thing left to worry about is wasting your time and money. **Statistical power** is the chance not of wasting your time and money. 
...
Power isn't an ancillary concern, it's the entire game from the very beginning of the planning stage. It should be at the forefront of the researcher's mind from the very beginning. You should want the power as high as possible.^[I hear that 80% is the standard, but I'm pretty uncomfortable spending dozens of hours and thousands of dollars running for a 1 in 5 chance of wasting my time. I want that chance as close to zero as I can get it. I want power close to 100%. 99% power and 80% power might both seem "high" or "acceptable," but these are not the same. 80% power means 1 in 5 studies fail. 99% power means that 1 in 100 studies fail.]

You have to supply the test with overwhelming evidence to consistently reject the null. Careful power calculations help you make sure you succeed in this war against the null.
