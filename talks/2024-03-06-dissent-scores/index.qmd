...
- `gamson.csv` is available [here](https://pos3713ri.github.io/data/gamson.csv), via the [data sets](https://pos3713ri.github.io/data.html) for my undergraduate research methods class.
