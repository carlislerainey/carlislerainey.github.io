...
twitter-card:
  ...
  title: "*For Your Syllabus:* Statistical Power"  # less than 55 chars
  description: "Five readings on power analysis, MDEs, sample size planning, and research design diagnostics."  # less than 125 chars
open-graph:
  image: "og-card.png"
  title: "*For Your Syllabus:* Statistical Power"  # less than 55 chars
  description: "Five readings on power analysis, MDEs, sample size planning, and research design diagnostics."  # less than 125 chars
...
## Quantitative Political Science Research is Greatly Underpowered (Arel-Bundock et al. 2026)
...
![Figure from Arel-Bundock et al. showing the distribution of statistical power across political science studies](images/arel-bundock-power-figure.png)
...
![Figure from Bloom (1995) illustrating the minimum detectable effect](images/bloom-mde-figure.png)
...
- 🔗 Preprint DOI (OSF): <https://doi.org/10.31219/osf.io/5am9q_v3>

![Figure from Rainey's "Power Rules" paper illustrating rules of thumb for power calculations](images/rainey-mde-figure.png)
...
![Table from Lakens (2022) summarizing the six sample size justifications](images/lakens-justification-table.png)
...
![Table from Blair et al. (2019) summarizing the MIDA framework for declaring research designs](images/blair-mida-table.png)
...
| [Rainey](https://doi.org/10.31219/osf.io/5am9q_v3) | Provides intuitive rules of thumb for power analysis, including using pilot data. |
