...
::: {.callout-tip}
- **You can find the paper [here](https://doi.org/10.31219/osf.io/5am9q_v3)**. 
- You can find an experimental R package at [here](https://www.carlislerainey.com/powerrules/). 
:::
