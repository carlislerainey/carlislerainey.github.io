---
title: "Power Rules @ Purdue"
description: "A talk at the [Department of Political Science](https://www.cla.purdue.edu/academic/polsci/index.html) and [The Methodology Center](https://www.purdue.edu/research/mcap/) at Purdue University."
...
::: {.callout-tip}
- **The paper is [on OSF](https://doi.org/10.31219/osf.io/5am9q_v3)**.
- You can find an experimental [R package](https://www.carlislerainey.com/powerrules/).
:::

- The code is [on GitHub](https://github.com/carlislerainey/power-rules).
- The slides are on [iCloud](https://www.icloud.com/keynote/0d6aPDe-yVieB2J1BTzRonphA#power-rules), or as a [PDF](https://www.dropbox.com/scl/fi/6fv0hwrh6vyy492e3e8iu/power-rules.pdf?rlkey=36q5k7joj0ci40xbyu9c4j3es&dl=0).


## Other things from me

- I've written [several blog posts](https://www.carlislerainey.com/blog/) on the topic.
