...
This post turned out to be somewhat popular, so I've written up a more formal, careful description of the idea in a full length paper. The initial, early version is [on GitHub](https://github.com/carlislerainey/power-rules/blob/main/power-rules.pdf).
:::
